...
const SignIn = React.lazy(() => import("./components/sections/registration/SignIn"));
const SignUp = React.lazy(() => import("./components/sections/registration/Signup"));
const AllPlayers = React.lazy(() => import("./components/pages/AllPlayers"));
